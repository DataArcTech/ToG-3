...
from rag_factory.prompts.prompt import QUERY_ANALYSIS_PROMPT, ANSWER_GENERATION_PROMPT
...
class EventGraphRetriever:
    ...
    def _build_generation_prompt(self, query: str, context_text: str) -> str:
        """构建生成prompt"""
        return ANSWER_GENERATION_PROMPT.format(query=query, context=context_text)
