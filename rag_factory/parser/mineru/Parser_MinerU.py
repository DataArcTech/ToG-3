    ...
    def _generate_outputs(self, pdf_info: Dict[str, Any], 
        ...
        try:
            ...
            if opts.get('f_dump_content_list', False):
                ...
                # Whether use dolphin to get better equation
...
if __name__ == '__main__':
    ...
    # pdf_files_dir = '/home/yangcehao/edu_project/documents_analysis/test_pdf'
    pdf_files_dir = '/home/yangcehao/edu_project/documents_analysis/test_pdf'
    output_dir = '/home/yangcehao/edu_project/documents_analysis/test_pdf/mineru_result'
